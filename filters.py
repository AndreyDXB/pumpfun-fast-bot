...
WATCH_SECONDS = 90             # наблюдаем 90 сек (было 60)
MIN_WALLETS = 10               # минимум 10 кошельков (было 5)
MIN_VOLUME_SOL = 1.0           # минимум 1 SOL объёма (было 0.3)
MAX_PRICE_DROP = 0.20
MAX_SINGLE_HOLDER_PERCENT = 35.0   # чуть строже (было 40%)
INSTANT_WHALE_PERCENT = 70.0       # чуть строже (было 80%)
            ...
            async for msg in ws:
                try:
                    ...
                    if tx_type == "buy":
                        ...
                        # Мгновенно блокируем только явных китов
